...
export async function POST(req: NextRequest) {
    // Initialisation du Pool APRES le début de la requête (Runtime)
    ...
    try {
        ...
        try {
            ...
            // Ce message sera déclenché si le mot de passe est INVALIDE (le format est corrigé par l'approche lazy)
            return NextResponse.json({ 
                success: false, 
